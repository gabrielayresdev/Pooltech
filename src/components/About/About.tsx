      ...
      <div className={styles.container}>
        ...
        <div className={styles.text}>
          ...
          <p className={styles.paragraph}>
            A "SPH Piscinas" é uma renomada empresa de manutenção de piscinas
            que tem se destacado no mercado por muitos anos. Com um firme
            compromisso com a excelência e a satisfação do cliente, a SPH
            Piscinas se tornou uma referência na indústria de manutenção de
            piscinas.
          </p>
          <p className={styles.paragraph}>
            ...
            SPH Piscinas entende que uma piscina limpa e bem mantida é um ativo
